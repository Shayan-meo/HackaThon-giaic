...
import item1 from "../../assets/images/Food Item 1.svg";
import item2 from "../../assets/images/Food Item 2.svg";
import item3 from "../../assets/images/Food Item 3.svg";
import item4 from "../../assets/images/Food Item 4.svg";
    ...
    <>
      <div className="container-fluid position-relative">
        <div className="position-absolute bg-img">
          <Image src={bgLeaf} alt="" className="leaf ms-5" />
        </div>
      </div>
